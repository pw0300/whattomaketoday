          ...
          <div className="relative flex-1 w-full flex items-center justify-center p-4">
              {isDeckEmpty ? (
                  ...
                  <div className="relative w-full max-w-xs aspect-[3/4.5]">
                      ...
                      >
                           {/* Card Header */}
                           <div className="bg-ink text-white py-3 px-4 flex justify-between items-center">
                                <span className="font-mono text-[10px] uppercase font-black tracking-widest">{currentDish.type}</span>
                                <div className="flex items-center gap-1.5">
                                    <span className="font-mono text-[10px] font-black opacity-50 uppercase">{currentDish.cuisine}</span>
                                </div>
                           </div>
                           ...
                           <div className="flex-1 p-6 flex flex-col">
                                ...
                                <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full border-2 text-[9px] font-black uppercase mb-6 self-start ${currentMatch >= 75 ? 'border-brand-500 bg-brand-50 text-brand-600' : 'border-gray-200 bg-gray-50 text-gray-400'}`}>
