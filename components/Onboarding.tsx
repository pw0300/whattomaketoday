          ...
          <div className="animate-in fade-in slide-in-from-right duration-300">
            ...
            <div className="mb-6">
               <label className="block text-sm font-medium text-gray-600 mb-2 flex items-center gap-2">
                 <FileText size={16} /> Biometric Data Ingestion (Lab Report)
               </label>
        ...
        {step === 3 && (
          <div className="animate-in fade-in slide-in-from-right duration-300">
            ...
            <div className="grid grid-cols-2 gap-3 mb-4">
              {CUISINE_SUGGESTIONS.map((cuisine) => (
                <button
                  ...
                  className={`p-3 border-2 transition-all flex justify-center items-center font-bold uppercase text-xs text-center h-12 ${
            ...
            <div className="mb-6">
                ...
                {/* Active Chips Display (for custom ones specifically, or all) */}
          ...
          <div className="animate-in fade-in slide-in-from-right duration-300">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
               {DIETARY_OPTIONS.map(opt => (
                 <button
                   ...
                   className={`p-3 border-2 transition-all font-bold uppercase text-xs ${
            ...
            <div className="bg-blue-50 border-2 border-blue-200 p-4 mb-6">
                <div className="flex items-center gap-2 mb-3 text-blue-700">
                    <Target size={16} />
                    <span className="font-black uppercase text-xs">TDEE Calculator</span>
                </div>
            ...
            />
             ...
             <div className="flex gap-4">
              ...
              >
                Launch OS <ArrowRight size={18} strokeWidth={3} />
              </button>
            </div>
          </div>
        )}
